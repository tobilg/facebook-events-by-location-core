...
EventSearch.prototype.search = function (options) {
    ...
    queryOptions.sort = options.sort ? (allowedSorts.indexOf(options.sort.toLowerCase()) > -1 ? options.sort.toLowerCase() : null) : null;
    ...
    return new Promise(function (resolve, reject) {
        ...
        if (!queryOptions.latitude || !queryOptions.longitude) {
            ...
            .then(function(results){
                ...
                console.log(JSON.stringify({events: events, metadata: {venues: venuesCount, venuesWithEvents: venuesWithEvents, events: eventsCount}}));
